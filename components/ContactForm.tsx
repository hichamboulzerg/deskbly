              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label htmlFor="name" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide text-stone-700">
                        Your Name
                      </label>
                      <input
                        id="name"
                    ...
                    <div>
                      <label htmlFor="email" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide text-stone-700">
                        Email Address
                      </label>
                      <input
                        id="email"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide text-stone-700">
                      Subject
                    </label>
                    <select
                      id="subject"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-xs font-semibold mb-1.5 uppercase tracking-wide text-stone-700">
                      Message
                    </label>
                    <textarea
                      id="message"
